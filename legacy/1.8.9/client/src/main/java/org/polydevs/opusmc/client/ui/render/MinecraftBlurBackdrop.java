...
public final class MinecraftBlurBackdrop {
    private static final ResourceLocation OPUS_BLUR =
            new ResourceLocation("opusclient", "shaders/post/opus_blur.json");
    ...
    public boolean begin() {
        ...
        try {
            ...
            minecraft.entityRenderer.loadShader(OPUS_BLUR);
