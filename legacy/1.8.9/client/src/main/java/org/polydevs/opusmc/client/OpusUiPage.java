...
import org.polydevs.opusmc.client.ui.UiPageAdapter;
...
abstract class OpusUiPage extends UiPageAdapter {
    ...
    OpusUiPage(ClientOverlayController controller, UiRuntime runtime) {
    ...
    final void renderControls(org.polydevs.opusmc.client.ui.UiRenderer renderer, org.polydevs.opusmc.client.ui.UiInput input) {
