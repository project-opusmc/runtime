...
import org.polydevs.opusmc.client.ui.render.MinecraftBlurBackdrop;
import org.polydevs.opusmc.client.ui.render.MinecraftUiScale;
import org.polydevs.opusmc.client.ui.render.MinecraftUiRenderer;
import org.polydevs.opusmc.client.ui.render.MinecraftTitlePanorama;
 ...
 */
final class OpusClientScreen extends GuiScreen {
    ...
    private org.polydevs.opusmc.client.ui.UiBounds productViewport;
    ...
    OpusClientScreen(ClientOverlayController controller, UiRoute initialRoute) {
        Minecraft minecraft = Minecraft.getMinecraft();
        runtime = new UiRuntime(
                new MinecraftUiRenderer(minecraft),
                new OpusUiPageFactory(controller),
                initialRoute);
