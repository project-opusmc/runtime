 ...
 * class at runtime.</p>
 */
public final class OpusClientOptionsScreenFactory {
    static final String CLASS_NAME = "org.polydevs.opusmc.client.gui.OpusClientOptionsScreen";
    static final String INTERNAL_NAME = "org/polydevs/opusmc/client/gui/OpusClientOptionsScreen";
    ...
    private OpusClientOptionsScreenFactory() {
    }
    ...
    private static byte[] createScreenBytecode() {
        ...
        writer.visit(
                ...
                GUI_SCREEN,
                null);
        writer.visitField(Opcodes.ACC_PRIVATE | Opcodes.ACC_FINAL, "opusParent", "Laxu;", null, null).visitEnd();
    ...
    private static void writeConstructor(ClassWriter writer) {
        ...
        method.visitFieldInsn(Opcodes.PUTFIELD, INTERNAL_NAME, "opusParent", "Laxu;");
    ...
    private static void closeScreen(MethodVisitor method) {
        ...
        method.visitVarInsn(Opcodes.ALOAD, 0);
        method.visitFieldInsn(Opcodes.GETFIELD, INTERNAL_NAME, "opusParent", "Laxu;");
