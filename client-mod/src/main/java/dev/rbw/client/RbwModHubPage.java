...
final class RbwModHubPage extends RbwPanelPage {
    ...
    RbwModHubPage(ClientOverlayController controller, UiRuntime runtime) {
        ...
        editHud = button("Edit HUD", UiActionButton.Tone.QUIET, new Runnable() {
            @Override public void run() { RbwModHubPage.this.runtime.navigate(UiRoute.hudEditor()); }
        });
    }
