...
import dev.rbw.core.ClientUiHooks;
...
public final class ClientOptionsTransformer implements ClassTransformer {
    ...
    static final String HOOKS_OWNER = "dev/rbw/core/ClientUiHooks";

    @Override
    public String id() {
        return "rbw.client-options";
    }
    ...
    public byte[] transform(String className, byte[] originalBytecode) {
        if (RbwClientOptionsScreenFactory.CLASS_NAME.equals(className)) {
            return RbwClientOptionsScreenFactory.screenBytecode();
        }
